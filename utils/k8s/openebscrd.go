...
// GetCStorVolumeReplica returns the CStorVolumeReplica object for given cvrName and namespace
...
// DeleteCStorVolumeReplica deletes a CStorVolumeReplica with the given cvrName and namespace
